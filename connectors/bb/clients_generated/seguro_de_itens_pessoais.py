"""
Seguro Itens Pessoais API v1.0.2
...
class SeguroDeItensPessoaisClient:
    base_url: str
    ...
    def post_cotacoes_objeto_segurado_bolsa(
        self,
        *,
        gw_dev_app_key: str = None,
        authorization_seg: str = None,
        ...
        if coligada is not None:
            headers["coligada"] = coligada
        path_params = {}
        path_rendered = "/cotacoes/objeto-segurado-bolsa".format(**path_params)
        response = requests.post(
            self.base_url + path_rendered, params=query, headers=headers, json=body
        )
        response.raise_for_status()
    ...
    def put_cotacoes_objeto_segurado_bolsa(
        self,
        *,
        gw_dev_app_key: str = None,
        authorization_seg: str = None,
    ...
    def post_cotacoes_objeto_segurado_conta(
        self,
        *,
        gw_dev_app_key: str = None,
        authorization_seg: str = None,
        ...
        if coligada is not None:
            headers["coligada"] = coligada
        path_params = {}
        path_rendered = "/cotacoes/objeto-segurado-conta".format(**path_params)
        response = requests.post(
            self.base_url + path_rendered, params=query, headers=headers, json=body
        )
        response.raise_for_status()
    ...
    def put_cotacoes_objeto_segurado_conta(
        self,
        *,
        gw_dev_app_key: str = None,
        authorization_seg: str = None,
    ...
    def post_cotacoes_plano_bolsa(
        ...
        *,
        ...
        if coligada is not None:
            headers["coligada"] = coligada
        path_params = {}
        path_rendered = "/cotacoes/plano-bolsa".format(**path_params)
        response = requests.post(
            self.base_url + path_rendered, params=query, headers=headers, json=body
        )
        response.raise_for_status()
    ...
    def post_cotacoes_plano_conta(
        ...
        *,
        ...
        if coligada is not None:
            headers["coligada"] = coligada
        path_params = {}
        path_rendered = "/cotacoes/plano-conta".format(**path_params)
        response = requests.post(
            self.base_url + path_rendered, params=query, headers=headers, json=body
        )
        response.raise_for_status()
