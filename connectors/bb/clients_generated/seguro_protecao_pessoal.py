"""
Seguro Proteção Pessoal API v1.0.0
...
class SeguroProtecaoPessoalClient:
    base_url: str
    ...
    def post_cotacoes_proponente(
        ...
        *,
        ...
        """
                <br/>
        <b>BRASIL_SEG -> /emissao/cotacao/v1/proponente</b>
        <br/>
        <br/>
    ...
    def delete_cotacoes_proponente(
        ...
        *,
        ...
        """
        <br/> <b>BRASIL_SEG -> /emissao/cotacao/v1/proponente</b> <br/> <br/> Realiza a Exclusão do proponente da cotação.
