...
class SeguroEmpresarialClient:
    ...
    def post_empresarial_cotacoes_emissao(
        self,
        *,
        gw_dev_app_key: str = None,
        ...
        path_params = {}
        path_rendered = "/empresarial/cotacoes/emissao".format(**path_params)
        response = requests.post(
            self.base_url + path_rendered, params=query, headers=headers, json=body
        )
        response.raise_for_status()
